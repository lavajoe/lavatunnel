...
/* ./.libs/lt-libconfig_tests.c - temporary wrapper executable for .libs/libconfig_tests.exe
   Generated by libtool (GNU libtool) 2.4.2

   The libconfig_tests program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "c:\\users\\chokeonmy\\Downloads\\libconfig-1.5\\lib\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "c:\\users\\chokeonmy\\Downloads\\libconfig-1.5\\tinytest;c:\\users\\chokeonmy\\Downloads\\libconfig-1.5\\lib\\.libs;C:\\MinGW\\msys\\1.0\\local\\lib;C:\\MinGW\\msys\\1.0\\local\\bin;";
const char * TARGET_PROGRAM_NAME = "libconfig_tests.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# libconfig_tests - temporary wrapper script for .libs/libconfig_tests.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The libconfig_tests program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' /c/users/chokeonmy/Downloads/libconfig-1.5/lib/.libs/libcon", f);
  fputs ("fig.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"libconfig_tests.exe:libconfig_tests:${LINENO}: libtool wrapper (GNU l", f);
  fputs ("ibtool) 2.4.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"libconfig_tests.exe:libconfig_tests:${LINENO}: newargv[$lt_dump_args", f);
  fputs ("_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"libconfig_tests.exe:libconfig_tests:${LINENO}: newargv[0]: $prog", f);
  ...
  fputs ("\n", f);
  fputs ("  program='libconfig_tests.exe'\n", f);
  ...
  fputs ("    PATH=/c/users/chokeonmy/Downloads/libconfig-1.5/tinytest:/c/users/chokeonmy", f);
  fputs ("/Downloads/libconfig-1.5/lib/.libs:/usr/local/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/c/users/chokeonmy/Downloads/libconfig-1.5/lib/.libs:$PATH\"\n", f);
  fputs ("\n", f);
