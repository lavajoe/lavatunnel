...
/* ./.libs/lt-example3.c - temporary wrapper executable for .libs/example3.exe
   Generated by libtool (GNU libtool) 2.4.2

   The example3 program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "example3.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# example3 - temporary wrapper script for .libs/example3.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The example3 program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"example3.exe:example3:${LINENO}: libtool wrapper (GNU libtool) 2.4.2\"", f);
  fputs (" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"example3.exe:example3:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"example3.exe:example3:${LINENO}: newargv[0]: $progdir/$program\" ", f);
  fputs ("1>&2\n", f);
