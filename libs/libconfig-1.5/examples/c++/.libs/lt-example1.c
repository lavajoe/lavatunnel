...
/* ./.libs/lt-example1.c - temporary wrapper executable for .libs/example1.exe
   Generated by libtool (GNU libtool) 2.4.2

   The example1 program cannot be directly executed until all the libtool
...
const char * EXE_PATH_VALUE   = "c:\\users\\chokeonmy\\Downloads\\libconfig-1.5\\lib\\.libs;C:\\MinGW\\msys\\1.0\\local\\lib;C:\\MinGW\\msys\\1.0\\local\\bin;";
const char * TARGET_PROGRAM_NAME = "example1.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# example1 - temporary wrapper script for .libs/example1.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The example1 program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../../lib/libconfig++.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"example1.exe:example1:${LINENO}: libtool wrapper (GNU libtool) 2.4.2\"", f);
  fputs (" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"example1.exe:example1:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"example1.exe:example1:${LINENO}: newargv[0]: $progdir/$program\" ", f);
  fputs ("1>&2\n", f);
  ...
  fputs ("    PATH=/c/users/chokeonmy/Downloads/libconfig-1.5/lib/.libs:/usr/local/lib:/u", f);
  fputs ("sr/local/bin:$PATH\n", f);
  fputs ("\n", f);
